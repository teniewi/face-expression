...
face_detector = cv2.CascadeClassifier(r'E:\Documents\Hisbul Wathoni\Github Project\face-expression\haarcascade_frontalface_default.xml')


#Inisiation Class Main menu
class mainMenu (QDialog):
    ...
    """
    #Function messege box for showing messege
    ...
    #Function Input to input new data from customer
    def input_(self):
    ...
    #Function Update to update data from customer if any changing
    def updated_(self):
        nama_pelanggan = self.tb1.toPlainText()
        nama_barang = self.tb2.toPlainText()
    ...
    #Function tampir to show data from database
    def tampil_(self):
        nama_pelanggan = self.tb1.toPlainText()
        db = con.connect(host = "localhost",user = "root",password = "",db = "riefhy_store", autocommit=True)
        cursor = db.cursor()
    ...
    #function clear to clear form in menu
    def clear_(self):
        self.tb1.setPlainText("")
        self.tb2.setPlainText("")
    ...
    #To start webcame if button clicked
    ...
    #To display image from webcapture
